...
public class TicTacToe implements ActionListener{
    //Creating Frame
    JFrame f = new JFrame("Game Tic Tac Toe");
    ...
    private void initUI(){
        ...
        btn1.setBackground(new Color(255,182,193));
        btn2.setBackground(new Color(255,182,193));
        btn3.setBackground(new Color(255,182,193));
        btn4.setBackground(new Color(255,182,193));
        btn5.setBackground(new Color(255,182,193));
        btn6.setBackground(new Color(255,182,193));
        btn7.setBackground(new Color(255,182,193));
        btn8.setBackground(new Color(255,182,193));
        btn9.setBackground(new Color(255,182,193));
        btn10.setBackground(new Color(240,255,255));
        ...
        btn1.setBorder(BorderFactory.createLineBorder(Color.decode("#F0FFFF")));
        btn2.setBorder(BorderFactory.createLineBorder(Color.decode("#F0FFFF")));
        btn3.setBorder(BorderFactory.createLineBorder(Color.decode("#F0FFFF")));
        btn4.setBorder(BorderFactory.createLineBorder(Color.decode("#F0FFFF")));
        btn5.setBorder(BorderFactory.createLineBorder(Color.decode("#F0FFFF")));
        btn6.setBorder(BorderFactory.createLineBorder(Color.decode("#F0FFFF")));
        btn7.setBorder(BorderFactory.createLineBorder(Color.decode("#F0FFFF")));
        btn8.setBorder(BorderFactory.createLineBorder(Color.decode("#F0FFFF")));
        btn9.setBorder(BorderFactory.createLineBorder(Color.decode("#F0FFFF")));
    ...
    private void checkWinner() {
        ...
        if (win) {
            lbl.setText("Hore! Kamu " + letter + " Menang!");
            btn1.setEnabled(false);
            btn2.setEnabled(false);
            btn3.setEnabled(false);
            btn4.setEnabled(false); 
            ...
            lbl.setText("Game Berakhir Seri.");
            btn1.setEnabled(false);
            btn2.setEnabled(false);
            btn3.setEnabled(false);
            btn4.setEnabled(false); 
